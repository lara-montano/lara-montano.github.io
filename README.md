...
I am an Assistant Professor and Researcher at the **Facultad de Ingenieria, Universidad Autonoma de Queretaro**, Mexico. Member of the **Sistema Nacional de Investigadores** (SNI, Candidate Level -- SECIHTI).
...
- **Metaheuristic algorithms:** development of the [Success-Based Optimization Algorithm (SBOA)](https://github.com/lara-montano/sboa-optimizer) and benchmarking against established methods
...
- **Process integration & energy systems:** microalgae-based biorefineries, sustainable aviation fuels, biomass valorization
- **Techno-economic analysis:** cost estimation tools ([COSTIQ](https://github.com/lara-montano/COSTIQ)) and economic evaluation of chemical processes
